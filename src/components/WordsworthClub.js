...
const WordsworthClub = () => {
  const clubDetails = {
    name: "Wordsworth Club",
    description: "Creative writing and literature.",
    founded: "2008",
  };

  const members = [
    { id: 1, name: "Samuel Blake", role: "Editor", email: "samuel@example.com" },
    { id: 2, name: "Clara White", role: "Poet", email: "clara@example.com" },
  ];
...
const styles = {
  ...
  clubHeader: {
    background: 'linear-gradient(45deg, rgba(139, 0, 0, 0.8), rgba(165, 42, 42, 0.8))',
